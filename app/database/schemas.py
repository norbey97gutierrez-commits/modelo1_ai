...
class ChatRequest(BaseModel):
    """Esquema de entrada para el endpoint de generación, incluyendo el contexto."""

    prompt: str = Field(description="El requerimiento técnico o pregunta del usuario.")
    conversation_id: Optional[uuid.UUID] = Field(
        None, description="ID de la conversación actual. Si es None, inicia una nueva."
    )
